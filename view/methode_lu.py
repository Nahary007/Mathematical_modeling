...
class LUView:
    ...
    def __init__(self, parent, go_home_callback):
        ...
        # Message placeholder
        message_label = tk.Label( self.parent, text="Implémentez ici la décomposition LU. Entrez votre matrice A et vecteur b pour résoudre Ax = b.", font=("Arial", 14), bg="white", fg="#4B5563", wraplength=500, justify="center" )
